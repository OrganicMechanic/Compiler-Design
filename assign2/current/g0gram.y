...
TableType: TABLE { $$ = $1; }
		...
		| TABLE LT Type CM Type GT { $$ = P(Table-Type2, 6, $1, $2, $3, $4, $5, $6); }
		;
...
CompilationUnit: TypeDeclarationsOpt { $$ = $1; }
		| FieldDeclaration CompilationUnit        { $$ = P(Compil-Unit2, 2, $1, $2); }
		| MethodDeclaration CompilationUnit        { $$ = P(Compil-Unit3, 2, $1, $2); }
		;

TypeDeclarationsOpt: TypeDeclarations { $$ = $1; }
	| { $$ = NULL; }
	;

TypeDeclarations: TypeDeclaration { $$ = $1; }
		| TypeDeclarations TypeDeclaration { $$ = P(Type-Decl1, 2, $1, $2); }
		;
...
PrimaryNoNewArray: Literal { $$ = $1; }
		| THIS { $$ = $1; }
		| LP Expression RP { $$ = P(PrimaryNoNew-Arry2, 2, $1, $2); }
		| FieldAccess { $$ = $1; }
		| ArrayAccess { $$ = $1; }
		;
