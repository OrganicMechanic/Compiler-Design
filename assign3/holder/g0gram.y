...
MethodDeclaration: MethodHeader MethodBody { $$ = ntree(METHOD_DECL1, 2, $1, $2); }
		;
...
IfThenStatement:  IF LP Expression RP Statement { $$ = ntree(IFTHEN_STMT1, 4, $1, $2, $3, $4); }
		;
...
WhileStatement:	  WHILE LP Expression RP Statement { $$ = ntree(WHILE_STMT1, 4, $1, $2, $3, $4); }
		;
